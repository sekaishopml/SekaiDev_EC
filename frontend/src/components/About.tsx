export default function About() {
  return (
    <section id="about" className="min-h-screen px-6 md:px-12 py-16 md:py-24 flex flex-col justify-center">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
        ...
        <div className="text-base md:text-lg lg:text-xl leading-relaxed text-foreground/80">
          <p className="mb-6">
