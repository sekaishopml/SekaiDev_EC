...
const TopLabels = () => (
  <div className="absolute top-24 md:top-28 left-6 right-6 z-20 grid grid-cols-2 md:grid-cols-4 gap-4 text-[10px] md:text-xs tracking-widest text-muted/90 uppercase pointer-events-none drop-shadow-sm">
...
const BottomLabels = () => (
  <div className="absolute bottom-4 md:bottom-8 left-6 right-6 z-20 grid grid-cols-2 gap-4 items-end pointer-events-none">
...
export default function Hero({ onBonsaiLoaded }: HeroProps) {
  return (
    <section id="home" className="relative h-full w-full overflow-hidden bg-background">
      <RainbowArc />
